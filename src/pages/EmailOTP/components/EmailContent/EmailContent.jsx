    ...
    return ( 
        ...
        xxl:w-[528px]">
            ...
            <div className="otp-input mt-8 mb-10">
             ...
             tb:w-80 mx-auto
             lg:w-96 mx-auto">
                <div className="resend-otp border border-indigo-300 rounded-lg py-3 cursor-pointer hover:scale-x-[1.03]">
                    <input type="button"  value='Resend OTP' className='text-indigo-300 '/>
                </div>
                <div className="validate-otp border rounded-lg bg-blue-700 py-3 cursor-pointer hover:scale-x-[1.03]">
                    <input type="button" value='Validate OTP' className='text-white'/>
                </div>
             </div>
             <div className="change-email text-blue-700 text-base leading-6 underline font-semibold">
